...
Route::middleware('auth:sanctum')->group(function() {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::post('products/getProductsData', function () {
            ...
            return [
                'mostViewedProducts' => $mostViewedProducts->original,
                'mostSellableProducts' => $mostSellableProducts->original,
                'revenue' => $revenue->original,
                'totalProducts' => $productsTotal->original,
                'totalOrders' => $ordersTotal->original,
                'totalNews' => $newsTotal->original,
                'totalUsers' => $usersTotal->original,
                'viewsDaily' => $viewsDaily->original,
                'soldDaily' => $soldDaily->original,
                'accessTimes' => $accessTimes->original,
                'totalMoney' => $totalMoney->original,
            ];
        });
    });
});
