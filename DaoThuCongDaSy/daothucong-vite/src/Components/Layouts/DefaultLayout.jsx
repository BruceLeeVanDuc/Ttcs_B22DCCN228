                ...
                <div className="header-mobile d-flex">
                    ...
                    <Sidebar visible={visible} header="Thanh điều khiển" onHide={() => setVisible(false)} style={{background:'#ffffff', width:'270px'}}>
                        ...
                        <ul className="menu-category">
                            ...
                            <li>
                                <a href="https://www.facebook.com/le.van.uc.23096">
                ...
                <div className="container-fluid header">
                    ...
                    <div className="phone d-flex position-relative ml-3">
                        ...
                        <div className="ml-2">
                            ...
                            <span className="d-block fs-4">0363490433</span>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6">
                            <div className="row">
                                <div className="contact col-md-6 p-0 m-0">
                                    ...
                                    <div className="mt-3">
                                        Điện thoại: <span> 0363490433</span>
                                    </div>
                                    <div className="mt-3">
                                        Email: <span>DucLV.B22CN228*@stu.ptit.edu.vn</span>
                                    </div>
                                    <div className="mt-3">
                                        Fanpage:
                                        <a className="d-block" href="https://www.facebook.com/le.van.uc.23096">https://www.facebook.com/le.van.uc.23096</a>
                                    </div>
                                    <div className="mt-3">
                                        Shopee:
                        ...
                        <div className="col-md-6 p-0 m-0">
                            <div className="row">
                                ...
                                <div className="social-media col-md-6 m-0">
                                    ...
                                    <a href="https://www.facebook.com/le.van.uc.23096" className="mt-3 fanpage">DAS - Dao Thủ Công Đa Sỹ</a>
                                    <div className="mt-3">
